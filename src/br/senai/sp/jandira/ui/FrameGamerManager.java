...
public class FrameGamerManager extends JFrame {
	...
	public FrameGamerManager() {
		...
		lblestimatedPrice.setForeground(Color.WHITE);
		...
		checkFinished.setForeground(Color.WHITE);
		...
		ImageIcon controle = new ImageIcon((getClass().getResource("/br/senai/sp/jandira/img/img.jpg")));

		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setBounds(384, 83, 320, 348);
		lblNewLabel.setIcon(new ImageIcon(FrameGamerManager.class.getResource("/br/senai/sp/jandira/img/img.jpg")));
		...
		btnSave.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (!txtTitle.getText().equals("") && !txtEstimatedPrice.getText().equals("")) {
					...
					JOptionPane.showMessageDialog(null, "Por favor preencha o formulario!",
							"Por favor preencha o formulario!", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
